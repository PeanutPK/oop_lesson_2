...
def gen_comb_list(list_set):
    """
    :param list_set: a list of lists where each contains at least one element
    :return: a list of lists, each of which is made from a combination
             of elements in each list in list_set

    EX: gen_comb_list([[1, 2, 3]])
    returns [[1], [2], [3]]

    EX: gen_comb_list([[1, 2, 3], [4, 5]])
    returns [[1, 4], [2, 4], [3, 4],
             [1, 5], [2, 5], [3, 5]]

    EX: gen_comb_list([[1, 2, 3], [4, 5], [6, 7, 8]])
