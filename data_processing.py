...
#
# print(
#     "Test select: only displaying two fields, city and latitude, for cities "
#     "in Italy")
...
#
# print(
#     "Calculating the average temperature without using aggregate for cities "
#     "in Italy")
# temps = []
...
# print()
#
# print("Calculating the average temperature using aggregate for "
#       "cities in Italy")
# print(my_table1_filtered.aggregate(lambda x: sum(x) / len(x), 'temperature'))
# print()
#
# print(
#     "Test join: finding cities in non-EU countries whose temperatures are "
#     "below 5.0")
...
#
# print(
#     "Print the min and max temperatures for cities in EU that do not have "
#     "coastlines")
